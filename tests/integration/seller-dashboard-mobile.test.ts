...
describe('P1.10 seller dashboard mobile adaptation', () => {
  it('hides the seller sidebar on mobile and shows it on md+', () => {
    const sidebar = read('apps/web/src/components/workspace/sidebar.tsx');
  ...
  it('adds a mobile menu toggle to the seller dashboard header', () => {
    const header = read('apps/web/src/components/seller-dashboard/DashboardHeader.tsx');
  ...
  it('supports closing the mobile sidebar after navigation', () => {
    const sidebar = read('apps/web/src/components/seller-dashboard/Sidebar.tsx');
  ...
  it('uses tap-to-toggle help popover constrained to the viewport', () => {
    const stage = read('apps/web/src/components/wizard/stages/StageOneMedia.tsx');
  ...
  it('uses responsive padding in seller inventory and settings views', () => {
    ...
    const settings = read('apps/web/src/components/seller-dashboard/SettingsForm.tsx');
  ...
  it('prevents horizontal overflow in the seller workspace', () => {
    const workspaceLayout = read('apps/web/src/components/workspace/workspace-layout.tsx');

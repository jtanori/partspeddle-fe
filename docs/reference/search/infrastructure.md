...
- `docs/archive/ALGOLIA_ATTRIBUTE_MATRIX.md`: Mapping of DB fields to Algolia attributes.
- `docs/archive/PRC_DB_SEARCH.md`: Database search certification.
- `docs/archive/SEARCH_AUDIT.md`: General search platform audit.
- [`Search Data Flow`](data-flow.md): Data movement from DB to Algolia.
- `docs/archive/SEARCH_HARDENING_PLAN.md`: Reliability improvements roadmap.
- [`Search Index Contract`](index-contract.md): Index consistency expectations.
- `docs/archive/SEARCH_PLATFORM_PRC.md`: Search Platform Production Readiness.
- [`Search V2 Index Spec`](v2-index-spec.md): Flattened Algolia index schema.
- `docs/archive/UI_SEARCH_PLAN.md`: Frontend search UI implementation plan.
...
The search engine uses a **Flattened Schema** to optimize performance and simplify frontend logic. This structure is defined in [`v2-index-spec.md`](v2-index-spec.md).

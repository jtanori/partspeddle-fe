...
> **Master Reference**: For detailed system architecture, data modeling, and synchronization strategies, please refer to the [Search Engine Infrastructure](infrastructure.md) document.
...
- **API Endpoint**: Expected pattern `/api/parts/search` (implied by [`data-flow.md`](data-flow.md)).

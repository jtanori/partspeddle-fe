...
See [`operations-env-mapping.md`](operations-env-mapping.md) for the full mapping.
...
- [ ] [`deployment-runbook.md`](deployment-runbook.md) documents the chosen migration strategy.
...
- [ ] Link this checklist and the drift report in [`../guides/prc.md`](../guides/prc.md) Section 11 evidence.

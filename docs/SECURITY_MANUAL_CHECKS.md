...
Use this checklist during the P5.8 production security certification. Record evidence (screenshots, curl output, HAR files) and link them from `docs/PRC.md` Section 11.

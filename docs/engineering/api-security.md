...
Browser-initiated APIs use cookie sessions via `@supabase/ssr`. M2M integrations use explicit Bearer tokens. See `docs/engineering/route-auth-matrix.md` for the full route × role × auth matrix.

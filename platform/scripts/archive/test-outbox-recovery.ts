...
async function runMidProcessingCrashTest(): Promise<{
  ...
  try {
    ...
    const workerProcess = exec("tsx platform/scripts/search/process-search-outbox.ts");
...
function runWorker(env: NodeJS.ProcessEnv = process.env): Promise<void> {
  return new Promise((resolve, reject) => {
    const workerProcess = exec("tsx platform/scripts/search/process-search-outbox.ts", { env });

...
export const PopularSellersSection: React.FC = () => {
  ...
  const { sellers } = useTopSellers({ limit: 5 });
          ...
          <div key={seller.id} className="bg-white border border-zinc-200 rounded p-4 shadow-xs relative flex flex-col justify-between hover:shadow-lg transition-all">
            <div className="space-y-3">
              <div className="aspect-video relative rounded overflow-hidden bg-zinc-800">
                <img src={seller.logoUrl || 'https://images.unsplash.com/photo-1549399542-7e3f8b79c341?auto=format&fit=crop&q=80&w=300'} alt={seller.businessName} className="w-full h-full object-cover" />
              ...
              <div className="space-y-1">
                <h3 className="font-display text-base font-bold text-[#1E1E1E] leading-tight line-clamp-1">{seller.businessName}</h3>

...
export const MobileNavDrawer: React.FC<MobileNavDrawerProps> = ({
  ...
  return (
    <div
      className="fixed inset-0 z-[9990] flex justify-end animate-fade-in"
        ...
        <div className="flex-grow">
          ...
          <div className="flex items-center justify-between border-b border-oil-dark pb-3">
            <div className="flex items-center gap-2 font-display">
              ...
              <p className="text-xs font-bold text-base-cream uppercase tracking-wider">
                PartsPeddle
              </p>
            </div>
            <button
          ...
          <nav className="py-4 space-y-4 font-sans">
            <AuthActions onClose={onClose} showToast={showToast} variant="list" />

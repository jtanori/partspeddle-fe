  ...
  return (
    <div className="bg-surface-primary border border-stroke-subtle rounded-xl p-6 shadow-card space-y-6">
        ...
        {parts.map((part) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[12px] font-black text-foreground-primary uppercase truncate tracking-tight group-hover:text-brand-primary transition-colors">
                {part.title}
              </p>
      ...
      <Link
        ...
        className="block text-brand-primary text-[10px] font-black uppercase tracking-[0.2em] w-full text-center hover:underline pt-2 border-t border-stroke-subtle mt-4"
      >

...
import { AlertTriangle, Eye, EyeOff, Mail, Lock, ChevronLeft } from 'lucide-react';
  ...
  return (
    <div className={isShaking ? 'animate-auth-shake' : ''}>
      ...
      <div className="mt-8 text-center text-xs text-zinc-500 font-sans border-t border-zinc-100 pt-6">
        New to PartsPeddle?
        <Link href="/register" className="text-rust-copper hover:underline font-bold uppercase tracking-wide text-[10px] ml-2">
          Join Now →
        </Link>
      </div>
    </div>

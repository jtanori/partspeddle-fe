import type { SpecGroup } from './compiled-specification-set';
import type { CompiledSpecificationSet } from './compiled-specification-set';
export type { CompiledSpecificationSet, SpecGroup };

export type LineageId = string & { __brand: 'LineageId' };

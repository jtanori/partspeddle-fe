    ...
    if (isOpen) {
      try {
        ...
        if (saved) {
          ...
          setRecentSearches(parsed.map((s: any) => (typeof s === 'string' ? s : s.query)));
        } else {
            ...
            <div className="text-center py-12 max-w-sm mx-auto space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-400 md:text-zinc-500 font-sans mt-1.5 leading-relaxed">
                  Please type{' '}
                  <span className="font-bold text-[#B87333]">at least 3 characters</span> to
                  initiate live parts inventory search lookup.
                </p>
              </div>
            </div>
          ) : query.trim().length === 0 ? (
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4" id="search-modal-results-list">
                {matchingParts.map((part) => {
                  ...
                  const yearMatch =
                    part.subtitle.match(/\d{4}-\d{4}/) || part.subtitle.match(/\d{4}/);
            ...
            <div className="text-center py-16 max-w-sm mx-auto space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-400 md:text-zinc-500 font-sans mt-1.5 leading-relaxed">
                  ...
                  {query}&quot; filter on {selectedSystem || 'all'} systems. Try entering a broader
                  keyword.
                </p>
              </div>
            </div>

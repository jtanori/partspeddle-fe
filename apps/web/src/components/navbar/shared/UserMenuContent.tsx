    ...
    return (
      <div className="p-4 bg-oil-dark/40 rounded-xl border border-oil-dark text-center space-y-3 font-sans">
        <p className="text-xs text-warm-gray">
          Access specialized supplier operations, escrow protections, and real-time teardowns.
        </p>
        <button
          onClick={() => {
            onClose();
    ...
    <div className="py-2">
      <div className="px-5 py-3 border-b border-stone-800 flex items-center gap-3">
        ...
        <div className="min-w-0">
          <p className="font-display text-[10px] text-warm-gray uppercase tracking-wider font-bold">
            LOGGED IN ACCOUNT
          </p>
      ...
      <p className="px-5 font-display text-[10px] text-warm-gray uppercase tracking-wider font-bold mb-1 mt-3">
        USER
      </p>
      <button
        onClick={() => {
      ...
      {userRole === 'seller' && (
        <>
          ...
          <p className="px-5 font-display text-[10px] text-warm-gray uppercase tracking-wider font-bold mb-1">
            SELLER TOOLS
          </p>
          <button
            onClick={() => {

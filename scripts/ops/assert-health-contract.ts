 ...
 *
 * Usage:
 *   tsx scripts/ops/assert-health-contract.ts https://stage.partspeddle.com
 *   tsx scripts/ops/assert-health-contract.ts --environment staging
 *   DEPLOYMENT_URL=https://stage.partspeddle.com tsx scripts/ops/assert-health-contract.ts
 */

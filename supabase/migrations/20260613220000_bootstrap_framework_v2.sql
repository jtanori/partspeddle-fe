-- PDP Modernization Schema: Catalog Specification Framework (Phase P1A.1)
-- Refined with strict data integrity constraints.
...
CREATE INDEX idx_catalog_spec_definitions_key ON public.catalog_spec_definitions(key);
